...
const Banner = () => {
    return (
        <div className="bg-white px-10 py-20">
            <div className="mx-auto flex max-w-6xl items-center justify-between gap-16">
                <div className="max-w-lg">
                    ...
                    <div className="mt-8 flex items-center gap-4">
                        <a href="#technologies"
                            className="rounded-lg bg-gradient-to-r from-[#f97316] to-[#ec4899] px-6 py-3 text-sm font-semibold text-white shadow-md shadow-pink-500/20 transition-opacity hover:opacity-90">
