...
const Footer = () => {
    return (
        <footer className="border-t border-slate-100 bg-white px-6 py-10 text-slate-500">
            <div className="mx-auto grid max-w-[835px] gap-8 sm:grid-cols-2 lg:grid-cols-[2fr_1fr_1fr_1fr]">
                <div>
                    <img className="w-[78px]" src={Logo} alt="Dev Stack" />
                    <p className="mt-3 max-w-[250px] text-[9px] leading-relaxed text-slate-400">
            ...
            <div className="mx-auto mt-8 flex max-w-[835px] flex-wrap justify-between gap-3 border-t border-slate-100 pt-4 text-[9px] text-slate-400">
